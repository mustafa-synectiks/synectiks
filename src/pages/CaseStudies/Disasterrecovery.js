        ...
        <div className="bg-lightgrey">
          ...
          <div className="px-5 pt-2">
            <p className="lineHeight-24">
              ...
              disaster recovery plan is set, any business can continue to run
              its critical operations without thwarting their customer
              expectations. That is exactly what we offered Indian defense, a
              solution that can manage and provide necessary outcomes in case of
              any DR issues.
            </p>
            <br />
          </div>
          ...
          <div className="p-5">
            ...
            <p className="lineHeight-24">
              <ul>
                ...
                <li>
                  The solution is extracted from components like snapshot
                  engine- pool provisioning –Zfs based storage and
            ...
            <p className="lineHeight-24">
              <b>
                That old Cliché “DR is resilient enough to implement in one go”
                we proved it wrong!
              </b>
              <br />
